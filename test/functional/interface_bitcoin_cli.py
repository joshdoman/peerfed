...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `peerfed-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and peerfed-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and peerfed-cli getwalletinfo return expected wallet info")
            ...
            # Test peerfed-cli -generate with -rpcwallet in multiwallet mode.
