...
bool CheckSignetBlockSolution(const CBlock& block, const Consensus::Params& consensusParams)
{
    ...
    TransactionSignatureChecker sigcheck(&signet_txs->m_to_sign, /* nInIn= */ 0, /* amountTypeIn= */ signet_txs->m_to_spend.vout[0].amountType, /* amountIn= */ signet_txs->m_to_spend.vout[0].nValue, txdata, MissingDataBehavior::ASSERT_FAIL);
