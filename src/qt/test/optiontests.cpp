...
void OptionTests::parametersInteraction()
{
    ...
    // With fListen=false in ~/.config/PeerFed/PeerFed-Qt.conf and all else left as default,
    // peerfed-qt should set both -listen and -listenonion to false and start successfully.
