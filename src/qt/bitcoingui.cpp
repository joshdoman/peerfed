...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and peerfed: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a peerfed: URI"));
...
void BitcoinGUI::addWallet(WalletModel* walletModel)
{
    ...
    connect(wallet_view, &WalletView::coinsConverted, this, &BitcoinGUI::gotoHistoryPage);
