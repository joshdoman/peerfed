...
QString BitcoinUnits::formatWithPrivacy(Unit unit, bool amountType, const CAmount& amount, SeparatorStyle separators, bool privacy)
{
    assert(amount >= 0);
    QString value;
    if (privacy) {
    ...
    return value + QString(" ") + shortName(unit) + QString::number(amountType);
}
