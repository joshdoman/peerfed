...
public:
    CMainParams() {
        ...
        consensus.powLimit = uint256S("000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");// TODO: revert (temporarily raised to accomodate easy initial difficult) uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 14 * 24 * 60 * 60; // two weeks
        consensus.nPowTargetSpacing = 10 * 60;
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.fMiningRequiresPeers = false; // TODO: revert to true (temporary for testing)
        ...
        consensus.nMinimumChainWork = uint256{}; // TODO: Set appropriate minimum (set to zero so that we don't think we're still downloading while testing) uint256S("0x00000000000000000000000000000000000000003404ba0801921119f903495e");
        ...
        genesis = CreateGenesisBlock(1684100738, 18655808, 0x1e00fff0, 1, 50 * COIN); // CreateGenesisBlock(1231006505, 2083236893, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000000ff217a1dabdf1c2196dee715e5bf0dbd841bcc0bb21ccf1afca26b10bd"));
...
public:
    CTestNetParams() {
        ...
        consensus.fPowNoRetargeting = false;
        consensus.fMiningRequiresPeers = true;
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1684080312, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0a6d3ce187824837a4317f0e37d6c043dc943d9c6dd21d8d505e231970c58a0e"));
        assert(genesis.hashMerkleRoot == uint256S("0x05f2dd47559dcc8a1c4ba95a022711ee0e9ccf3f763c3dc3446fbc91957d9f2c"));
