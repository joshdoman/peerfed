        ...
        CallOneOf(
            ...
            [&] {
                ...
                if (ContainsSpentInput(transaction, coins_view_cache)) {
                    // Avoid:
                    // consensus/tx_verify.cpp:171: bool Consensus::CheckTxInputs(const CTransaction &, TxValidationState &, const CCoinsViewCache &, int, CAmounts &, std::optional<CTxConversionInfo> &): Assertion `!coin.IsSpent()' failed.
                    return;
                }
