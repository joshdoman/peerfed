...

    {
        ...
        if (mutable_transaction) {
            ...
            if (n_in < script_tx_to.vin.size()) {
                (void)SignSignature(provider, ConsumeScript(fuzzed_data_provider), script_tx_to, n_in, CASH, ConsumeMoney(fuzzed_data_provider), fuzzed_data_provider.ConsumeIntegral<int>());
                MutableTransactionSignatureCreator signature_creator{tx_to, n_in, CASH, ConsumeMoney(fuzzed_data_provider), fuzzed_data_provider.ConsumeIntegral<int>()};
