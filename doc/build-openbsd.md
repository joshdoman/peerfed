...
This guide describes how to build peerfedd, command-line utilities, and GUI on OpenBSD.
...
It is not necessary to build wallet functionality to run either `peerfedd` or `peerfed-qt`.
...
PeerFed Core includes a GUI built with the cross-platform Qt Framework. To compile the GUI, Qt 5 is required.
