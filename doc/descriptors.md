# Support for Output Descriptors in PeerFed Core

Since PeerFed Core v0.17, there is support for Output Descriptors. This is a
...
transactions related to the multisig. Lastly, it is not recommended to use anything other than a PeerFed Core descriptor wallet to serve as your
...
existing PeerFed Core wallets, a convenience function `combo` is
...
All RPCs in PeerFed Core will include the checksum in their output. Only
