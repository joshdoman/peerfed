...
These tools must be installed in order to build PeerFed Core from source.
...
PeerFed Core includes a GUI built with the cross-platform Qt Framework.
...
You can deploy a `.dmg` containing the PeerFed Core application using `make deploy`.
...
Run the following in your terminal to compile PeerFed Core:
...
``` bash
/Users/${USER}/Library/Application Support/PeerFed/
```

Before running, you may create an empty configuration file:

```shell
mkdir -p "/Users/${USER}/Library/Application Support/PeerFed"

touch "/Users/${USER}/Library/Application Support/PeerFed/peerfed.conf"

chmod 600 "/Users/${USER}/Library/Application Support/PeerFed/peerfed.conf"
```
