...
Assumeutxo is a feature that allows fast bootstrapping of a validating peerfedd
...
considered active. This is the "traditional" mode of operation for peerfedd.
...
**Failure consideration:** if peerfedd unexpectedly halts after `m_stop_use` is set on
...
When peerfedd initializes again, what began as the snapshot chainstate is now
