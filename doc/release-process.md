...
* Update peerfed.conf and commit, see [gen-peerfed-conf.sh](https://github.com/bitcoin/bitcoin/blob/master/contrib/devtools/README.md#gen-peerfed-confsh).
...
Checkout the PeerFed Core version you'd like to build:
...
- Update other repositories and websites for new version
  ...
  - Update packaging repo
      ...
      - Push the flatpak to flathub, e.g. https://github.com/flathub/org.bitcoincore.peerfed-qt/pull/2
