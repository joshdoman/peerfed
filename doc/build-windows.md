...
Below are some notes on how to build PeerFed Core for Windows.

The options known to work for building PeerFed Core on Windows are:
...
Note that for WSL the PeerFed Core source path MUST be somewhere in the default mount file system, for
