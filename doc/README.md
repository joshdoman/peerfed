...
Running
---------------------
The following are some helpful notes on how to run PeerFed Core on your native platform.
...
Drag PeerFed Core to your applications folder, and then run PeerFed Core.
...
Building
---------------------
The following are developer notes on how to build PeerFed Core on your native platform. They are not complete guides, but include notes on the necessary libraries, compile flags, etc.
...
- [peerfed.conf Configuration File](peerfed-conf.md)
