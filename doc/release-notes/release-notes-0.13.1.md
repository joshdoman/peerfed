...
- #8492 `8b0bdd3` Allow building bench_peerfed by itself (luke-jr)
...
- #8860 `0bee740` util: Move wait_peerfedds() into stop_nodes() (MarcoFalke)
...
- #8817 `bcf3806` update peerfed-tx to output witness data (jnewbery)
