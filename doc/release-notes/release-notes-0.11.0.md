...
For example, add the following to `peerfed.conf`:
...
- #5809 `46bfbe7` Add peerfed-cli man page
...
- #5849 `41259ca` contrib/init/peerfedd.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for peerfed-tx)
