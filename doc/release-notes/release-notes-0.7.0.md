...
We recommend that everybody running prior versions of peerfedd/Bitcoin-Qt
...
bitcoin up-to-date.  Just type
  ...
  sudo apt-get update
in your terminal, then install the peerfed-qt package:
  sudo apt-get install peerfed-qt
...
* (Windows only): enable ASLR and DEP for peerfed-qt.exe
* (Windows only): add meta-data to peerfed-qt.exe (e.g. description)
...
* Bash programmable completion for peerfedd(1)
