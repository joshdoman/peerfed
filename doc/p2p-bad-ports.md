When PeerFed Core automatically opens outgoing P2P connections, it chooses
...
and usually require authentication. A connection attempt (by PeerFed Core,
...
Below is a list of "bad" ports which PeerFed Core avoids when choosing a peer to
