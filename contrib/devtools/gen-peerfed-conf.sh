...
BITCOIND=${BITCOIND:-$BINDIR/peerfedd}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/peerfed.conf}
...
then
  ...
  echo -e "To safely generate a peerfed.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example peerfed.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-peerfed-conf.sh.
##
...
# parse the output from peerfedd --help
