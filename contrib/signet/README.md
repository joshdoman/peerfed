...
Syntax: `getcoins.py [-h|--help] [-c|--cmd=<peerfed-cli path>] [-f|--faucet=<faucet URL>] [-a|--addr=<signet bech32 address>] [-p|--password=<faucet password>] [--] [<peerfed-cli args>]`

* `--cmd` lets you customize the peerfed-cli path. By default it will look for it in the PATH
...
* `--addr` lets you specify a Signet address; by default, the address must be a bech32 address. This and `--cmd` above complement each other (i.e. you do not need `peerfed-cli` if you use `--addr`)
...
To mine the first block in your custom chain, you can run:
    ...
    CLI="./peerfed-cli -conf=mysignet.conf"
