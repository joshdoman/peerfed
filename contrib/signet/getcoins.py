...
parser = argparse.ArgumentParser(description='Script to get coins from a faucet.', epilog='You may need to start with double-dash (--) when providing peerfed-cli arguments.')
parser.add_argument('-c', '--cmd', dest='cmd', default='peerfed-cli', help='peerfed-cli command to use')
...
parser.add_argument('bitcoin_cli_args', nargs='*', help='Arguments to pass on to peerfed-cli (default: -signet)')
