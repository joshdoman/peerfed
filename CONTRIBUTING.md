Contributing to PeerFed Core
============================

The PeerFed Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "PeerFed Core
...
Before you start contributing, familiarize yourself with the PeerFed Core build
system and tests. Refer to the documentation in the repository on how to build
PeerFed Core and how to run the unit tests, functional tests, and fuzz tests.
...
[PeerFed Core PR Review Club](https://bitcoincore.reviews/) meeting.
...
Most communication about PeerFed Core development happens on IRC, in the
...
For all other issues and pull requests, the https://github.com/peerfed/peerfed node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to peerfed-qt
...
fork of PeerFed Core copies the merge. Instead, make any username mentions in a
...
When a pull request conflicts with the target branch, you may be asked to rebase it on top of the current target branch.
    ...
    git fetch https://github.com/peerfed/peerfed  # Fetch the latest upstream commit
...
The following applies to code changes to the PeerFed Core project (and related
projects such as libsecp256k1), and is not to be confused with overall PeerFed
Network Protocol consensus changes.

Whether a pull request is merged into PeerFed Core rests with the project merge
maintainers.
...
Patches that change PeerFed consensus rules are considerably more involved than
...
Where a patch set proposes to change the PeerFed consensus, it must have been
